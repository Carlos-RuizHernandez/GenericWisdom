...
const brandInfoData = [
  ...
  },
  {
    ...
    price: '7.99',
    generic: 'generic',
    pros: ['prevents nausea', 'prevents dizziness', 'treats sneezing', 'treats runny nose', 'prevents other allergy symptoms'],
  ...
  {name: 'Ibuprofen', 
    ...
    rating: 4.0,
    description: 'Ibuprofen is a nonsteroidal anti-inflammatory drug (NSAID) thats used to temporarily relieve fever, pains, and aches in adults and children.',
